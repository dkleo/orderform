...
public class LittleSisters extends AbstractPdfView {
    ...
    protected void buildPdfDocument(
        ...
        Phrase p7 = new Phrase(new Chunk("Little Sisters", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 14))) ;
...
//        }
        ...
        Image img = Image.getInstance(context.getRealPath("images/book-cover-196x300.jpg"));
        img.scalePercent(66);
